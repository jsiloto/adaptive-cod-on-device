...
def efficientnet_params(model_name):
    ...
    params_dict = {
        ...
        'efficientnet-b1': (1.0, 1.1, 240, 0.0),
        'efficientnet-b2': (1.1, 1.2, 260, 0.0),
        'efficientnet-b3': (1.2, 1.4, 300, 0.0),
        'efficientnet-b4': (1.4, 1.8, 380, 0.0),
        'efficientnet-b5': (1.6, 2.2, 456, 0.0),
        'efficientnet-b6': (1.8, 2.6, 528, 0.0),
        'efficientnet-b7': (2.0, 3.1, 600, 0.0),
        'efficientnet-b8': (2.2, 3.6, 672, 0.0),
        'efficientnet-l2': (4.3, 5.3, 800, 0.0),
    }
...
def efficientnet(width_coefficient=None, depth_coefficient=None, dropout_rate=0.0,
                 drop_connect_rate=0.0, image_size=None, num_classes=1000):
